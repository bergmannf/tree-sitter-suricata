...
enum {
  ...
  anon_sym_BANG = 41,
  anon_sym_DOT = 42,
  sym_network_octet = 43,
  sym_network_subnet_mask = 44,
  anon_sym_LBRACK = 45,
  anon_sym_RBRACK = 46,
  anon_sym_COMMA = 47,
  sym_port_single = 48,
  ...
  sym_options = 74,
  sym_option = 75,
  sym_option_key_value = 76,
  sym_comment = 77,
  aux_sym_file_repeat1 = 78,
  aux_sym_network_list_entry_repeat1 = 79,
  aux_sym_port_list_repeat1 = 80,
  aux_sym_option_repeat1 = 81,
};
